...
// FFTW3
#include <complex.h> //Complex siempre va primero
#include <fftw3.h>
...
int jack_callback (jack_nframes_t nframes, void *arg){
	...
	b_samples_i++;
	if (b_samples_i >= delay_samples)
  	b_samples_i = 0;
	return 0;
}
	}
	else {
		printf ("The delay is greater than the latency");
...
int main (int argc, char *argv[]) {
	...
	b_samples = (jack_default_audio_sample_t *)malloc(delay_samples *sizeof(jack_default_audio_sample_t));
